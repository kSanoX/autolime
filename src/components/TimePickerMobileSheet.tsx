  ...
  return (
    <>
      ...
      <motion.div
        ...
        className='fixed inset-x-0 bottom-0 z-[1000] bg-white rounded-t-2xl min-h-[300px] overflow-y-auto shadow-xl cursor-grab p-4 w-full max-w-screen-sm mx-auto'
        style={{ paddingTop: "16px" }}>
        <div className='flex flex-col gap-6'>
          {/* Drag-полоска */}
          <div className='flex justify-center mt-4'>
            <div className='h-1.5 w-10 rounded-full bg-gray-300 mb-4' />
          </div>

          <h3 className='text-center text-base font-semibold text-gray-800 p-0' style={{ padding: "0px" }}>
            Choose a time
          </h3>
          ...
          >
            {TIME_OPTIONS.map((time) => (
              <div className='flex gap-3'>
                <div
                  style={{ padding: "11px" }}
                  className='bg-[#183D69] rounded-[12px]'
                >
                  <svg
                    width='20'
                    height='20'
                ...
                <button
                  ...
                  className={`py-2 px-4 rounded-lg border ${
                    selectedTime === time
                      ? "bg-[#CDF5D8] text-[#17BA68] font-semibold"
                      : "bg-white text-[#183D69] border-gray-300"
                  }`}
                >
                  {time}
                </button>
          ...
          <button
            className='calendar-select-btn mt-4 mx-auto'
